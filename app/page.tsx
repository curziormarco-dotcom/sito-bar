...
const HOME_COPY: Record<Language, Record<string, string>> = {
  it: {
    ...
    seeAll: "Vedi tutto →",
    bookTitle: "Prenota",
    bookSubtitle: "Scrivici su WhatsApp o chiamaci.",
    call: "Chiama",
    drinkAlt: "Aperitivo",
  },
  en: {
    ...
    seeAll: "See all →",
    bookTitle: "Book",
    bookSubtitle: "Message us on WhatsApp or call us.",
    call: "Call",
    drinkAlt: "Aperitif",
  },
  fr: {
    ...
    seeAll: "Voir tout →",
    bookTitle: "Réserver",
    bookSubtitle: "Écris‑nous sur WhatsApp ou appelle‑nous.",
    call: "Appeler",
    drinkAlt: "Apéritif",
  },
  de: {
    ...
    bookSubtitle: "Schreib uns auf WhatsApp oder ruf an.",
    call: "Anrufen",
    drinkAlt: "Aperitif",
  },
  es: {
    ...
    seeAll: "Ver todo →",
    bookTitle: "Reservar",
    bookSubtitle: "Escríbenos por WhatsApp o llámanos.",
    call: "Llamar",
    drinkAlt: "Aperitivo",
  },
};
